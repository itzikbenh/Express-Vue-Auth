        ...
        <div class="w-full max-w-xs mt-6 mb-0 mx-auto">
            <form class="bg-white shadow-md rounded px-4 pt-6 pb-8 mb-4" @submit.prevent="submit">
                ...
                <div class="flex items-center justify-between mb-4">
                    <label>
                        <input type="checkbox" :true-value="1" :false-value="0" v-model="form.remember">
                        <span class="ml-2 text-xs">Remember me</span>
                    </label>
                    <router-link class="inline-block align-baseline font-bold text-xs text-blue hover:text-blue-darker"
